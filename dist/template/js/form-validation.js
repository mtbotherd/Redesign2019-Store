...
$(function () {
  ...
  $('form').validate({
    ...
    success: function success(label, element) {// Add the span element, if doesn't exists, and apply the icon classes to it.
    ...
    highlight: function highlight(element, errorClass, validClass) {
      ...
      $(element).parents('.form-group, .input-group, .custom-control').addClass(errorClass).removeClass(validClass); // Sets error icon.

      $(element).next('.alert-red').show()
      /*addClass("fa-exclamation-triangle").removeClass("fa-check")*/
      ;
    },
